...
namespace Emart.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            options.UseSqlServer(Configuration.GetConnectionString("DefaultConnectionString"),x => x.MigrationsAssembly("Emart.Repository"));
            options.UseQueryTrackingBehavior(QueryTrackingBehavior.NoTracking);
            });

            //services.AddScoped<IItemCategoryService,ItemCategoryService>();
            services.AddTransient<IItemCategoryService,ItemCategoryService>();
            services.AddTransient<IItemCategoryById,ItemCategoryById>();
